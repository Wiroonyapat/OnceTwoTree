...
namespace myTextureInGame
{
    public class MyTextureInGame
    {
        ...
        private Vector2 my_origin_Default;
        ...
        public MyTextureInGame(ContentManager content, string asset, Color Texture_Colour, string origin_Horizontal, string origin_Vertical, Vector2 scale, float depth)
        {
            ...
            #region origin
            if (origin_Horizontal == "Left" || origin_Horizontal == "left")
            {
                my_origin.X = 0;
            }

            else if (origin_Horizontal == "Center" || origin_Horizontal == "center")
            {
                my_origin.X = my_Texture.Width * 0.5f * my_scale.X;
            }
            
            else if (origin_Horizontal == "Right" || origin_Horizontal == "right")
            {
            ...
            if (origin_Vertical == "Top" || origin_Vertical == "top")
            {
                my_origin.Y = 0;
            }
            
            if (origin_Vertical == "Center" || origin_Vertical == "center")
            {
                my_origin.Y = my_Texture.Height * 0.5f * my_scale.Y;
            }
            
            if (origin_Vertical == "Bottom" || origin_Vertical == "bottom")
            {
        ...
        public void Set_Data(Color? Texture_Colour, string origin_Horizontal, string origin_Vertical, Vector2? scale, float? depth) // ใช้เซ็ตข้อมูลภายใน 
        {
            ...
            {
                my_origin.X = my_origin_Default.X;
            }
            ...
            {
                my_origin.Y = my_origin_Default.Y;
            }
            #endregion             
            // set origin of Texture
